...
class MonthlyreportResource extends Resource
{
    ...
    {
        return Auth::user()?->hasAnyRole(['super_admin', 'admin', 'kepala']) ?? false;
    }
    ...
    public static function infolist(Schema $infolist): Schema
        {
            return $infolist
                ->schema([
                    \Filament\Schemas\Components\Section::make('Informasi Penyusun')
                        ->schema([
                        ...
                        ->collapsible(),
                    \Filament\Schemas\Components\Section::make('Tahun dan Bulan Laporan')
                        ->schema([
                            TextEntry::make('year')
                                ->label('Tahun')
                                ->weight(FontWeight::Bold),
                    ...
                    ->collapsible(),
                    \Filament\Schemas\Components\Section::make('Pengesahan Dukungan Manajemen')
                        ->schema([
