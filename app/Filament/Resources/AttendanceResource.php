...
class AttendanceResource extends Resource
{
                ...
                Filter::make('start_date')
                    ...
                    ->indicateUsing(function (array $data): array {
                        ...
                        if ($data['created_from'] ?? null) {
                            $indicators[] = Indicator::make('Dari: ' . \Carbon\Carbon::parse($data['created_from'])->toFormattedDateString())
                                ->removeField('created_from');
                        }

                        if ($data['created_until'] ?? null) {
                            $indicators[] = Indicator::make('Sampai: ' . \Carbon\Carbon::parse($data['created_until'])->toFormattedDateString())
    ...
    {
        return [
            RelationManagers\DailyReportsV2RelationManager::class
        ];
    }
